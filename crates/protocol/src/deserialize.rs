...
mod tests {
  ...
  fn test_deserialize() {
    ...
    TestCase { name: "HISTORY", input: b"HISTORY id=1 channel=!1@localhost direction=backward from_seq=5 history_id=h1 limit=10", expected: Ok(Message::History(HistoryParameters { id: 1, history_id: StringAtom::from("h1"), channel: StringAtom::from("!1@localhost"), from_seq: 5, limit: 10, direction: Some(StringAtom::from("backward")) })) },
    TestCase { name: "HISTORY without direction", input: b"HISTORY id=1 channel=!1@localhost from_seq=5 history_id=h1 limit=10", expected: Ok(Message::History(HistoryParameters { id: 1, history_id: StringAtom::from("h1"), channel: StringAtom::from("!1@localhost"), from_seq: 5, limit: 10, direction: None })) },
